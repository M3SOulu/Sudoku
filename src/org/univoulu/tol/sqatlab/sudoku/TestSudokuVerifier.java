...
public class TestSudokuVerifier {
	...
	public void testSecondRule(){
		...
		String s="417369825632158947958724316825437169791586432346912758289643571573291684164875293";
	...
	public void testThirdRule(){
		...
		s="123123123456456456789789789123123123456456456789789789123123123456456456789789789";
		assertEquals(-3,sudoVer.verify(s));
	}
	...
	public void testFourthRule(){
		...
		s="123456789456789123789123456123456789456789123789123456123456789456789123789123456";
		assertEquals(-4,sudoVer.verify(s));
